#!/usr/bin/python3
# Simple script to check our HIBP subscription status
...
def do_check():
    ...
    checkurl = "https://haveibeenpwned.com/api/v3/subscription/status"
...
def __main__():
    ...
    parser = argparse.ArgumentParser(description='Query our subscription status with haveibeenpwned.com', usage='%(prog)s')
